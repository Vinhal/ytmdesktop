    ...
    <div class="bg-opacity-5 bg-white shadow sm:rounded-lg mt-4" v-if="getStartedEnabled">
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="mt-2 max-w-xl text-sm text-gray-200">
          <p>
            Welcome to YouTube Music, here you can adjust settings to your liking aswell as
    ...
    <div class="px-3 flex flex-col gap-4 mt-4">
      ...
      <div
        :class="[
          ...
          apiEnabledSetting
            ? 'bg-black bg-opacity-20 -mx-4 px-4 pt-1.5 pb-2.5 rounded-lg'
            : 'mt-1.5',
        ]"
      >
        ...
        <template v-if="apiEnabledSetting">
          <settings-input
            ...
            class="bg-transparent border-0 -mx-2.5"
          >
